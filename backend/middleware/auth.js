...
module.exports = (req, res, next) => {
  try {
    ...
    const decodedToken = jwt.verify(token, process.env.JWT_SECRET); // Vérifie et décode le token en utilisant la clé secrète stockée dans les variables d'environnement
